                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <input class="form-input mt-2 block w-full" id="title" name="title" type="text" required>
                        </div>
                        <div class="mb-6">
                            <label class="block text-lg font-medium text-gray-700 dark:text-gray-300" for="body">Blog Body Text</label>
                            <textarea class="form-textarea mt-2 block w-full" id="body" name="body" rows="5" required></textarea>
                        </div>
                        <div class="text-right">
                            <button type="submit" class="btn-style">Create</button>
                        </div>
                    </form>
                </div>
            </div>
